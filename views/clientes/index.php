            ...
            <div class="card-body p-3">
                ...
                <div class="row justify-content-center p-5 shadow-lg">
                    ...
                    <form id="FormClientes">
                        ...
                        <div class="row mb-3 ">
                            <div class="col-lg-6">
                                <label for="cliente_fecha" class="form-label">Fecha</label>
                                <input type="datetime-local" class="form-control" id="cliente_fecha" name="cliente_fecha" placeholder="Fecha de registro">
                            </div>
                        </div>
